...
#define TFT_1_ROT 1        // TFT 1 rotation (0=portrait, 1=landscape, 3=landscape flipped)
#define TFT_2_ROT 1        // TFT 2 rotation 
#define EYE_1_XPOSITION  60        // x shift for eye 1 image on display (center 200px eye on 320px wide screen)
#define EYE_2_XPOSITION  320 - 128 // x shift for eye 2 image on display

// Screen dimensions for Elecrow ESP32 2.4" display (240x320)
#define SCREEN_WIDTH  240
#define SCREEN_HEIGHT 320

// Size of the window we draw on-screen (smaller than 200x200 so we can pan)
#define VIEW_W 160
#define VIEW_H 160

#define DISPLAY_BACKLIGHT  27 // Pin for backlight control (-1 for none)
#define BACKLIGHT_MAX    255
// Backlight brightness levels (0-255)
#define BACKLIGHT_NORMAL 180    // Normal brightness (adjust this for your preference!)
#define BACKLIGHT_DIM    60     // Dimmed brightness during blinks
#define BACKLIGHT_BRIGHT 255    // Maximum brightness
// Enable dynamic backlight effects (comment out to disable)
#define DYNAMIC_BACKLIGHT

// Function declaration for backlight control (implemented in eye_functions.cpp)
void setBacklight(uint8_t brightness);

// EYE LIST ----------------------------------------------------------------
#define NUM_EYES 1 // Number of eyes to display (1 or 2)

// Structure definition for eye info
...
// External declaration - actual definition is in main.cpp
